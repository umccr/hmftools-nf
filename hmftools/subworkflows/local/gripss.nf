...
include { GRIPSS_GERMLINE } from '../../modules/umccr/nextflow_modules/gripss/germline/main'
include { GRIPSS_SOMATIC  } from '../../modules/umccr/nextflow_modules/gripss/somatic/main'
